...
const SuccessPayment = () => {
       ...
       const confirmaPlataInBackend = async () => {
                   if (idInscriere && !requestTrimis.current) {
                       ...
                       //extrage tokenul
                        ...
                        //trimitere token-ul in configurarea Axios — session_id e folosit pentru deduplicare in backend
    ...
    return (
        <div className="container mt-5 text-center">
            ...
            <Link to="/user-profile" className="btn btn-primary mt-3">Vezi Înscrierile Mele</Link>
        </div>
    );
};
